			...
			<table>
				<thead>
					<tr>
						...
						<td width="20%">关键词</td>
						<td width="10%">
							<img class="fabu" title="批量发布" src="../../assets/fabu.png" alt="" @click="sentAll">&nbsp;&nbsp;&nbsp;
							<img class="quxiao" title="批量删除" src="../../assets/quxiao.png" alt="" @click="delAll">
						</td>
					</tr>
				</thead>
				<tbody>	
					<tr v-for="(item,index) in realTextArr">
						...
						<td>{{item.keyword}}</td>
						<td>
							<img class="fabu" title="发布" src="../../assets/fabu.png" alt="" @click="sentOne(item.articleId,index)">&nbsp;&nbsp;&nbsp;
							<img class="quxiao" title="删除" src="../../assets/quxiao.png" alt="" @click="delThis(item.articleId,index)">
						</td>
					</tr>
					<tr style="height:30px;">
						<td v-if="sentTextList.length==0||selectShow==true||fuzzyShow==true" colspan="7" style="text-align:center;">没有待发布文章</td>
					</tr>
				</tbody>
			</table>
			<div class="page-div">
...
<style>
	...
	.articleSend .searchTable .el-input input{
		border: 1px solid #cccccc;
